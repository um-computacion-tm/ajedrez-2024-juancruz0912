...
class TestTablero(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tablero.__tablero__[4][4] = '  '  # Limpiar casilla central para pruebas
    ...
    def test_movimiento_recto_valido_horizontal(self):
        self.tablero.__tablero__[1][2] = '  '
        self.assertTrue(self.tablero.movimiento_tablero_valido(1, 2, self.tablero.piezas['Torre 1 negro'])) 

    
    def test_movimiento_invalido(self):
        self.assertFalse(self.tablero.mover_pieza_tablero(7, 'A', 'Caballo 1 blanco'))
    ...
    def test_movimiento_recto_comer_horizontal(self):
        self.tablero.__tablero__[8][2] = self.tablero.piezas['Peon 1 negro']
        self.assertEqual(self.tablero.movimiento_tablero_valido(8, 2, self.torre_blanca), True)

    def test_movimiento_recto_comer_vertical(self):
        self.tablero.__tablero__[5][1] = self.torre_blanca
        self.torre_blanca.fila = 5
        self.assertEqual(self.tablero.movimiento_tablero_valido(2, 1, self.torre_blanca), True)

    def test_movimiento_recto_final_no_valido_horizontal(self):
        self.assertFalse(self.tablero.comer_pieza(8, 2, self.torre_blanca))

    # Verificando el movimiento diagonal válido
    def test_mover_pieza_tablero_diagonal(self):
        self.tablero.__tablero__[7][2] = '  '  
        self.tablero.mover_pieza_tablero(6, 'A', 'Alfil 1 blanco')
        self.assertIsInstance(self.tablero.__tablero__[6][1], Alfil)
    ...
    def test_movimiento_diagonal_comer(self):
        self.tablero.__tablero__[7][7] = self.tablero.piezas['Peon 1 negro']
        self.assertEqual(self.tablero.movimiento_tablero_valido(7, 7, self.alfil_blanco), True)
    ...
    def test_mover_caballo_invalido(self):
        self.assertFalse(self.tablero.mover_pieza_tablero(7, 'D', 'Caballo 1 blanco'))

    def test_movimiento_peon_invalido(self):
        self.assertFalse(self.tablero.mover_pieza_tablero(4, 'A', 'Peon 1 blanco'))


    def test_movimiento_diagonal_peon_invalido(self):
        self.tablero.__tablero__[4][1] = self.alfil_blanco
        self.assertFalse(self.tablero.mover_pieza_tablero(4, 'A', 'Peon 1 blanco'))
    ...
    def test_mover_pieza_tablero(self):        
        ...
        self.assertIsInstance(self.tablero.__tablero__[5][1], Peon)

    # Mover pieza al mismo lugar
    def test_mismo_lugar(self):
        self.assertFalse(self.tablero.mover_pieza_tablero(1, 'A', 'Torre 1 negro'))



    # Mover pieza a una posición ocupada por una pieza de su mismo color
    def test_mover_pieza_tablero_cassilla_ocupada(self):
        self.assertFalse(self.tablero.mover_pieza_tablero(3, 'A', 'Torre 1 blanco'))
    ...
    def test_comer_pieza_caballo(self):
        ...
        self.tablero.__tablero__[6][3] = self.peon
        self.tablero.mover_pieza_tablero(6, 'C', 'Caballo 1 blanco')
        self.assertIsInstance(self.tablero.__tablero__[6][3], Caballo)
    ...
    def test_comer_pieza_peon(self):
        ...
        self.tablero.__tablero__[6][3] = peon
        peon.fila = 6
        peon.columna = 3
    ...
    def test_jaque_devuelve_true(self):
        ...
        self.tablero.__tablero__[4][4] = rey_blanco
        torre_negra.fila = 4
        torre_negra.columna = 1
        self.tablero.__tablero__[4][1] = torre_negra
    ...
    def test_jaque_mate_tablero_devuelve_false(self):
        ...
        self.tablero.__tablero__[1][1] = rey_blanco
        self.tablero.piezas.pop('Torre 1 negro')
        self.tablero.__tablero__[2][1] = '  '
        self.tablero.__tablero__[1][2] = '  '
        reina_negra.fila = 1
        reina_negra.columna = 3
        self.tablero.__tablero__[1][3] = reina_negra
    ...
    def test_jaque_mate_tablero_devuelve_true1(self):
        ...
        rey_blanco.fila = 3
        rey_blanco.columna = 1
        self.tablero.__tablero__[3][1] = rey_blanco
        reina_negra.fila = 3
        reina_negra.columna = 2
        self.tablero.__tablero__[3][2] = reina_negra
        torre_negra.fila = 4
        torre_negra.columna = 1
        self.tablero.__tablero__[4][1] = torre_negra
    ...
    def test_jaque_caballo(self):
        ...
        self.tablero.__tablero__[2][3] = caballo_blanco
    ...
    def test_salvar_jaque_bloqueando_camino(self):
        ...
        torre_negra = self.tablero.piezas['Torre 1 negro']
        self.tablero.__tablero__[2][5] = '  '
        self.tablero.__tablero__[2][4] = torre_negra
        self.tablero.__tablero__[4][5] = torre_blanca
        torre_blanca.fila = 4
    ...
    def test_no_poder_bloquear_camino(self):
        ...
        self.tablero.__piezas__.pop('Peon 6 blanco')
        self.tablero.__tablero__[7][6] = '  '
        self.tablero.__tablero__[5][8] = reina_negra
        self.tablero.__tablero__[7][7] = '  '
        peon7_blanco.fila = 5
